...
# Title: Top Block
# Generated: Wed Apr 26 18:23:53 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gain = gain = 20
        self.freqc = freqc = 101.8e6
        self.audio_gain = audio_gain = 1

        ##################################################
        # Blocks
        ##################################################
        self._gain_range = Range(-1, 49, 1, 20, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, "gain", "counter_slider", float)
        self.top_layout.addWidget(self._gain_win)
        self._freqc_range = Range(52e6, 150e6, 10e3, 101.8e6, 200)
        self._freqc_win = RangeWidget(self._freqc_range, self.set_freqc, "freqc", "counter_slider", float)
        self.top_layout.addWidget(self._freqc_win)
        self._audio_gain_range = Range(10e-3, 100, 100e-3, 1, 200)
        ...
        self.rtlsdr_source_0.set_center_freq(freqc, 0)
    ...
    def set_freqc(self, freqc):
        self.freqc = freqc
        self.rtlsdr_source_0.set_center_freq(self.freqc, 0)
